...
parser.add_argument('--mode',default='data_creation', type=str, choices=['data_creation', 'training', 'prediction'])
#folders where to find noise audios and clean voice audio to prepare training dataset (mode data_creation)
parser.add_argument('--noise_dir', default='/Users/i521826/study/speakup-project/data-processing/train/noise', type=str)

parser.add_argument('--voice_dir', default='/Users/i521826/study/speakup-project/data-processing/train/clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='/Users/i521826/study/speakup-project/data-processing/train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/Users/i521826/study/speakup-project/data-processing/train/time_series/', type=str)

parser.add_argument('--path_save_sound', default='/Users/i521826/study/speakup-project/data-processing/train/sound/', type=str)
